...
const Singlepost = () => {
    ...
    const handleUpdate = async ()=>{
        try{
            await axios.put(`https://devstop.onrender.com/api/posts/${post._id}` ,
            {
    ...
    const handleDelete =async () =>{
        try{
            await axios.delete(`https://devstop.onrender.com/api/posts/${post._id}` ,{data:{username:user.username}});
    ...
    useEffect(()=>{
        const getPost = async () =>{
            const res = await axios.get("https://devstop.onrender.com/api/posts/"+ path);
            setPost(res.data)
